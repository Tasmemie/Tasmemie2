...
// this function creates a three-column table and adds it to the screen
   ...
   var tocTool1 = 'انقر للترتيب بحسب العنوان';
   var tocHead2 = 'التاريخ';
   var tocTool2 = 'انقر للترتيب بحسب التاريخ';
   var tocHead3 = 'الصنف';
   var tocTool3 = '';
   if (sortBy == "titleasc") { 
      tocTool1 += ' (descending)';
   ...
   if (numDisplayed == postTitle.length) {
      var tocNote = '<span class="toc-note"> عدد المشاركات ' + postTitle.length + '<br/></span>'; }
   else {
